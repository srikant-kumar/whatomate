...
<Aside type="tip">
  Use 2-column layouts for sections with many short fields like order details. Use 1-column layouts for sections with longer values like addresses or descriptions.
</Aside>
